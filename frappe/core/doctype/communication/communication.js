frappe.ui.form.on("Communication", {
	...
	reply: function (frm) {
		...
		$.extend(args, {
			...
			content: JSON.stringify(frm.doc.content), //! pass the content in json format, otherwise content will pass without a newline.
			is_a_reply: true,
			sent_or_received: frm.doc.sent_or_received, //! to check , is the mail is received
		});
